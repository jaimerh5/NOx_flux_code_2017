...
points (Fecha[1:29],
        ...
        xlab=" ",ylab=" ", main = '',
        cex.main=2, cex.lab=1,
        ty='o',col="#01665e",pch=1,cex=1.5,lty=1,lwd=2,
        ylim =c(0,500))
...
for (k in 1:length(ttoU_DayMean$SD.Urea.NO)) {
  segments(ttoU_DayMean[['Fecha']][k],ttoU_DayMean[['Mean.Urea.NO']][k],ttoU_DayMean[['Fecha']][k],ttoU_DayMean[['Mean.Urea.NO']][k]+ttoU_DayMean[["SD.Urea.NO"]][k]/sqrt(24), col="#01665e", lwd=2)
  segments(ttoU_DayMean[['Fecha']][k],ttoU_DayMean[['Mean.Urea.NO']][k],ttoU_DayMean[['Fecha']][k],ttoU_DayMean[['Mean.Urea.NO']][k]-ttoU_DayMean[["SD.Urea.NO"]][k]/sqrt(24), col="#01665e", lwd=2)}
for (k in 1:length(ttoU.NI_DayMean$SD.U.NI.NO)) {
  segments(ttoU.NI_DayMean[['Fecha']][k],ttoU.NI_DayMean[['Mean.U.NI.NO']][k],ttoU.NI_DayMean[['Fecha']][k],ttoU.NI_DayMean[['Mean.U.NI.NO']][k]+ttoU.NI_DayMean[["SD.U.NI.NO"]][k]/sqrt(8), col='#3288bd',lty=1, lwd=2)
  segments(ttoU.NI_DayMean[['Fecha']][k],ttoU.NI_DayMean[['Mean.U.NI.NO']][k],ttoU.NI_DayMean[['Fecha']][k],ttoU.NI_DayMean[['Mean.U.NI.NO']][k]-ttoU.NI_DayMean[["SD.U.NI.NO"]][k]/sqrt(8), col='#3288bd',lty=1, lwd=2)}
...
arrows(x0 = ejeTime[1],y0 = 350,x1 = ejeTime[1],y1 = 300,col = 'black',lwd = 2)
text(x =ejeTime[1],y = 355,labels = 'Fertilizaton',cex=0.5)
...
cex.pch <-  c(1,1.5,1,1.5,1,1.5,1,1.,1,1)
legend('topright',
       legend=leyend , 
       pch=PtoTyp,bty='y',
       lty=LineTyp,lwd=2,
...
points  (Fecha,
         ...
         xlab='',ylab='', main='',
         cex.main=2, cex.lab=1,
         ty='p',col="#fdae61",pch=18,cex=1.5,lty=1,lwd=1, 
         ylim =c(0,500))
attach(ttoU.UI_DayMean)
points(Fecha,
       Mean.U.UI.NO,
...
points  (Fecha,
         ...
         xlab='',ylab='', main='',
         cex.main=2, cex.lab=1,
         ty='p',col="#b2abd2",pch=4,cex=1,lty=4,lwd=1, 
         ylim =c(0,500))
